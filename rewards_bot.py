...
def typeSearch(page, keyword):
    ...
    try:
        page.wait_for_selector(search_select, timeout=3000)
        search_input = page.locator(search_select).first

        search_input.click()
        search_input.fill("")

        search_input.type(keyword, delay=random.randint(45, 90))
...
def execMobileSearch():
    ...
    with sync_playwright() as pw:
        ...
        try:
            ...
            time.sleep(random.uniform(2.05, 2.95))
            ...
            for idx, keyword in enumerate(MOBILEDAILYSEARCH, 1):
                ...
                wait_time = random.uniform(2.66, 3.66)
...
if __name__ == "__main__":
    ...
    print("\n[$] Intermission: Profile switching in 2 seconds...")
    time.sleep(2)
